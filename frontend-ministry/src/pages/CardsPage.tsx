...
import CardFooter from "@/components/CardPageFooter";
  ...
  return (
    <div className="flex h-screen bg-gray-100  flex-col justify-center items-center p-6">
      ...
      <CardFooter
        ...
        setCardNumber={setCardIndex}
        maxCardNumber={cards.length}
      />
      <CardPageScrollbar
        cards={cards}
        cardNumber={cardIndex}
      ...
      />
      <CardNavigator
        onPrev={decrementCardIndex}
        onNext={incrementCardIndex}
        addVertical
      />
    </div>
  );
